...
{
	[Guid("4839cba6-4638-417b-b856-fc1d72d68eaf")]
	public class Scrap : UyumObjectBase
	{
		...
		private int _ScrapId = 0;//integer
		...
		[Server]
		[DataInt32("scrap_id", IsIdentity = true)]
		[UyumPrimaryKey(0)]
