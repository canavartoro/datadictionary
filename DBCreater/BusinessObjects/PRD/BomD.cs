...
{
	[Guid("391d0eaf-9d43-4927-bc6d-49fdc68f9d61")]
	public class BomD : UyumObjectBase
	{
		...
		private int _ErpBomDId = 0;//integer
		...
		[Server]
		[DataInt32("bom_d_id", IsIdentity = true)]
		[UyumPrimaryKey(0)]
		...
		[Server]
		[DataInt32("erp_bom_d_id")]
		public int ErpBomDId
		{
			get { return _ErpBomDId; }
			set { _ErpBomDId = value; }
		}
	...
	[DataContract(Name = "BomD")]
	public class BomDInfo
	{
		...
		[DataMember(Name = "erp_bom_d_id")]
		public int ErpBomDId { get; set; }
